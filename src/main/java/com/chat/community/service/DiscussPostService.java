...
public class DiscussPostService {
    ...
    public List<DiscussPost> findDiscussPostsByMode(int userId, int offset, int limit,int Mode) {
        return discussPostMapper.selectDiscussPostsByMode(userId, offset, limit,Mode);
    }

    public List<DiscussPost> findNewsByMode(int userId, int offset, int limit,int Mode) {
        return discussPostMapper.selectNewsByMode(userId, offset, limit,Mode);
    }
    ...
    public int findDiscussPostRowsByMode(int mode) {
        return discussPostMapper.selectDiscussPostRowsByMode(mode);
    }

    public int findNewsRows(int userId) {
        return discussPostMapper.selectNewsRows(userId);
    }

    public int findNewsRowsByMode(int mode) {
        return discussPostMapper.selectNewsRowsByMode(mode);
    }
